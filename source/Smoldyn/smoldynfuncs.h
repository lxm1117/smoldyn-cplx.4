...
enum MolecState molstring2ms(char *sting);					// in smolmolec.c
...
int molexpandlist(molssptr mols, int dim, int ll, int nspace, int nmolecs);
int boundarytest(simptr sim, double *pos);
double molec_distance(simptr sim, double *pos1, double *pos2);
void rotation_compensate(double rotation_mtrx1[3][3], double rotation_mtrx2[3][3], double *vec, double *r_vec);
void rotation_update(double rotation_mtrx[3][3], int rotation_dim, double angle);
void inv3by3(double result[3][3], double m[3][3]);
int complex_connect(simptr sim, moleculeptr mptr1, moleculeptr mptr2);
int statesparser(molssptr mols, char *s);
...
int rxnsetrate(simptr sim,int order,int r,char* estr);
...
// reaction input process
char* strtrim(char *str);
char* strsplit(char *str, char *delim);
char* strextract(char *str, char *symbols);
double rxnparser(molssptr mols, char *str, int *molec_numptr, int *orderptr, int *prdptr, rct_mptr *rct1ptr, rct_mptr *rct2ptr, prd_mptr *prd1ptr, prd_mptr *prd2ptr);

// rxnptr RxnAddReactionCheck(simptr sim,char *rname,int molec_num,int order,int *rctident,enum MolecState *rctstate,int nprod,int *prdident,enum MolecState *prdstate, int *sites_state1, int *sites_state2, compartptr cmpt,surfaceptr srf);
int loadrxn(simptr sim,ParseFilePtr *pfpptr,char *line2);
int rxnsupdate(simptr sim);

// core simulation functions
int doreact(rxnssptr rxnss,gpointer rptr,moleculeptr mptr1,moleculeptr mptr2,int ll1,int m1,int ll2,int m2,double *pos,panelptr pnl,int bind_site_indx1,int bind_site_indx2,double radius,double dc1, double dc2);
...
int surfsetaction(surfaceptr srf,int i,enum MolecState ms,enum PanelFace face,enum SrfAction act,int site);
